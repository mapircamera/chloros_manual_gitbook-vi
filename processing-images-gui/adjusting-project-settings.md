...
{% hint style="info" %}**Cài đặt được lưu tự động**với dự án của bạn. Khi bạn mở lại một dự án, tất cả các cài đặt sẽ được khôi phục.
{% endhint %}***
...
* **EVI**: Vùng có chỉ số diện tích lá cao (LAI)**Công thức tùy chỉnh (chỉ Cloros+):**
...
4. Nhấp vào biểu tượng lưu**Những lợi ích:**
...
2. Trong Cài đặt dự án, bật hộp kiểm **"Áp dụng chỉnh sửa PPK"**3. Đặt**"Độ lệch múi giờ của cảm biến ánh sáng"** nếu cần (mặc định: 0 cho UTC)
4. Gán camera cho các chân phơi sáng:
   * **Camera đơn**: Tự động được gán cho Chân 1
   * **Camera kép**: Chỉ định thủ công từng camera cho mã pin chính xác**Gán chốt phơi sáng:***
